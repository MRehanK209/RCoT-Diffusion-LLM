...
The key result is Countdown Base. LLaDA-Base and Dream-Base correlate at $r=0.638$, which exceeds Dream-Base--Qwen-Base at $r=0.572$ even though Dream shares Qwen's pretrained lineage. Trip Planning Instruct adds a complementary observation: cross-paradigm correlations are uniformly low, especially Dream-Instruct--Qwen-Instruct at $r=0.157$.
...
The oracle analysis reports upper-bound complementarity from the existing samples. On Countdown base, the best single model solves $509$ of $992$ questions, while a Dream$+$Qwen oracle union solves $541$ and the full four-model union solves $604$. On Trip Planning base, the best single model solves $51$ of $200$ questions, while Dream$+$Llama solves $64$ and the full four-model union solves $71$. No practical selector is implemented.
