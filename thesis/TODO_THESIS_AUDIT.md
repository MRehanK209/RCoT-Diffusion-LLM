...
- GSM8K remains partly saturated, so it mostly supports RQ3 and RQ5 rather than the central ranking claim.
...
- Remaining issues are layout warnings only: mostly overfull or underfull boxes in a few wide tables and long qualitative-example lines.
